...
export default {
  ...
  data () {
    return {
      ...
      last_aqis: [],
      texts: ['Good', 'Moderate', 'Unhealthy for sensitive groups', 'Unhealthy', 'Very Unhealthy', 'Hazardous'],
      leftClasses: ['bg-green-300', 'bg-yellow-400', 'bg-orange-400', 'bg-red-400', 'bg-purple-400', 'bg-pink-700'],
      rightClasses: ['bg-green-200', 'bg-yellow-300', 'bg-orange-300', 'bg-red-300', 'bg-purple-300', 'bg-pink-600']
    }
  },
  created () {
    this.fetchAQIData()
